...
document.querySelector(".door-up-button3").innerHTML += TriangleButtonUI("door-screen1", "images/Circle-Triangle-UpsideDown.png");
...
//greg room
document.querySelector(".greg").innerHTML += CharactersUI("images/stacy.svg");
